    ...
    <>
      ...
      <section className="lp-section" id="workflow" style={{ paddingTop: 0 }}>
        ...
        <div className="lp-feature lp-feature-grad-1">
          <div className="lp-feature-text lp-reveal" style={revealDelay(0)}>
            ...
            <button type="button" className="lp-feature-cta" onClick={onDemoTodos}>
              칸반 체험하기 →
            </button>
          </div>
          <div className="lp-mock lp-reveal" style={revealDelay(140)} aria-hidden="true">
        ...
        <div className="lp-feature lp-feature-grad-2 reverse" id="sync">
          <div className="lp-mock lp-reveal" style={revealDelay(140)} aria-hidden="true">
            ...
            <Commit repo="archive-app" msg="feat(calendar): sticky sub-header" sha="8f23c41" />
            <Commit repo="archive-app" msg="fix(toast): auto-dismiss timing" sha="1a44b09" />
            <Commit repo="design-tokens" msg="chore: bump dark palette" sha="c0a8d1e" />
            <div className="lp-commit-synced">
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#30d158" strokeWidth="2.4" strokeLinecap="round" strokeLinejoin="round">
          ...
          <div className="lp-feature-text lp-reveal" style={revealDelay(0)}>
            ...
            <button type="button" className="lp-feature-cta" onClick={onDemoRetro}>
              연동 살펴보기 →
            </button>
          </div>
        </div>
        ...
        <div className="lp-feature lp-feature-grad-3" id="ai">
          <div className="lp-feature-text lp-reveal" style={revealDelay(0)}>
            ...
            <p>
              매주 일요일 자정 · 매월 말일 · 매년 마지막 날. 그동안의 흐름을 AI가
              스스로 정리해 마크다운 요약으로 만들고, 우상단 토스트로 살며시
              알려드립니다.
            </p>
            <button type="button" className="lp-feature-cta" onClick={onDemoSettings}>
              템플릿 편집기 보기 →
            </button>
          </div>
          <div className="lp-mock lp-reveal" style={revealDelay(140)} aria-hidden="true">
            <div className="lp-mock-head">
              <span className="lp-mock-dot" style={{ background: "#0a84ff" }} />
      ...
      <section className="lp-quote">
        <blockquote className="lp-reveal" style={revealDelay(0)}>
          &ldquo;도구와 트렌드는 바뀌어도,{" "}
          <span className="hl">남겨둔 기록은 사라지지 않는다.</span> 하루의 끝에서
          모든 것이 한 자리에 모인다.&rdquo;
        </blockquote>
...
function Commit({ repo, msg, sha }: { repo: string; msg: string; sha: string }) {
  return (
