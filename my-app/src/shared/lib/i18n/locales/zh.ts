...
export const zh: Dict = {
  ...
  "auth.signup.error.cooldown": "验证码刚刚已发送，请稍后再请求。",
  "auth.signup.error.notVerified": "请先验证邮箱。",
  "auth.signup.error.deliveryFailed": "验证邮件发送失败，请稍后重试。",
  "auth.signup.error.attemptsExceeded": "错误次数过多，请重新获取验证码。",
  "auth.signup.error.unavailable": "由于临时问题，请求未能处理，请稍后重试。",
  ...
  "auth.oauth.error.popupBlocked": "弹窗被拦截，请允许弹窗后重试。",
  "auth.oauth.error.codeInvalid": "授权已过期或已被使用，请重新登录。",
  "auth.oauth.error.stateInvalid": "登录会话已过期，请重试。",
  "auth.oauth.error.emailNotVerified": "该账户没有已验证的邮箱，请先完成邮箱验证后重试。",
  "auth.oauth.error.providerUnavailable": "登录服务暂时无法连接，请稍后重试。",
  "auth.oauth.error.providerResponseInvalid": "无法处理登录服务的响应，请稍后重试。",
  "auth.oauth.error.accountAlreadyLinked": "该账户已关联到其他用户。",
