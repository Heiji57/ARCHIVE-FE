...
export const ko: Dict = {
  ...
  "auth.signup.error.cooldown": "인증 코드를 방금 보냈어요. 잠시 후 다시 요청해주세요.",
  "auth.signup.error.notVerified": "이메일 인증을 먼저 완료해주세요.",
  "auth.signup.error.deliveryFailed": "인증 메일을 보내지 못했어요. 잠시 후 다시 시도해주세요.",
  "auth.signup.error.attemptsExceeded": "입력 시도 횟수를 초과했어요. 새 코드를 요청해주세요.",
  "auth.signup.error.unavailable": "일시적인 문제로 요청을 처리하지 못했어요. 잠시 후 다시 시도해주세요.",
  ...
  "auth.oauth.error.popupBlocked": "팝업이 차단됐어요. 팝업을 허용한 뒤 다시 시도해주세요.",
  "auth.oauth.error.codeInvalid": "인증이 만료됐거나 이미 사용됐어요. 다시 로그인해주세요.",
  "auth.oauth.error.stateInvalid": "로그인 세션이 만료됐어요. 다시 시도해주세요.",
  "auth.oauth.error.emailNotVerified": "연결하려는 계정에 인증된 이메일이 없어요. 계정의 이메일 인증 후 다시 시도해주세요.",
  "auth.oauth.error.providerUnavailable": "로그인 서비스에 일시적으로 연결할 수 없어요. 잠시 후 다시 시도해주세요.",
  "auth.oauth.error.providerResponseInvalid": "로그인 서비스 응답을 처리하지 못했어요. 잠시 후 다시 시도해주세요.",
  "auth.oauth.error.accountAlreadyLinked": "이 계정은 이미 다른 사용자에게 연결되어 있어요.",
